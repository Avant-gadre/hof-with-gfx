...
def outpuGfx(text):
    ...
    global TAG
    pngpath = "gfx/interface/traits/" + TAG
    txtfile = open(interfacePath + "trait_" + TAG + ".gfx", "w", encoding="UTF-8")
    # spriteTypes = {
...
pngpathfirst = "..\\gfx\\interface\\traits\\"
taglist = getDir(pngpathfirst)
print("将生成以下tag民族精神的gfx文件")
print(taglist)
input("")
interfacePath = "..\\interface\\traits\\"
...
for TAG in taglist:
    ...
    gfxfilename = interfacePath + "trait_" + TAG + ".gfx"
